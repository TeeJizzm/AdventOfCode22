...
Here are the first positions of start-of-message markers for all of the above examples:
    ...
    nznrnfrfntjfmvfwmzdfjlvtqnbhcprsg: first marker after character 29Your device's communication system is correctly detecting packets, but still isn't working. It looks like it also needs to look for messages.
